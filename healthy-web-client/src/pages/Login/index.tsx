...
export default function Login() {
  ...
  // 微信工作平台测试号的appID
  // 微信授权后的重定向地址
  const redirectUrl = `http://${process.env.REACT_APP_SERVER_URL}/api/user/wxAuthorize`
  // 拼接好的微信授权路径
  const url = `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${process.env.REACT_APP_APPID}&redirect_uri=${redirectUrl}&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect`
